...
void displayAnalysisResults() {
  for (float i = 0; i < 10; i++) {
    ...
    textSize(10);
    if (img != null) {
      text(String.format("%4.0f",i*(height - 150)),width - picWidth - 40,h*750000/(img.width*img.height));
    } else {
      text(String.format("%4.0f",i*(height - 150)),width - picWidth - 40,h*750000/5038848);
    }
  }
