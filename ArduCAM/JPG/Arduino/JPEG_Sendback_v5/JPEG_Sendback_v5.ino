...
// 3. Write the picture data to an SD card and Processing via Serial port.
// 5. Close the file.
// Messages are also sent through the Serial port to processing.
...
void setup() {
  ...
  //sendText("Please wait for image to load onto the SD card");
  sendText("----------------------------");
