...
//  outFile = SD.open(str,O_READ);
//
//
//  Serial.println("xlQPnM64\n"); // Code for start of picture
//  Serial.println(outFile.size());
//  Serial.println(outFile.position());
//  
//  while (outFile.position() < outFile.size()) {
//    Serial.write(outFile.read());
//  }
//  
//  Serial.println("zsKdR98Q\n"); // Code for end of picture
//
//
//  outFile.close();
