...
void displayAnalysisResults() {
  ...
  for (int i = 0; i < counts.length; i++) {
    if ((float)(i + 1)*765/counts.length < averageBrightness*765 && !hitWhite) {
  ...
  if (averageBrightness > 0) {
    stroke(255,255,0);
    strokeWeight(2);
    line(averageBrightness*(width - picWidth - 50),height - (float)linePosition/10 - 400,averageBrightness*(width - picWidth - 50),100);
    line(averageBrightness*(width - picWidth - 50),height - (float)linePosition/10 - 350,averageBrightness*(width - picWidth - 50),height - 50);
    ...
    textAlign(CENTER);
    textSize(20);
    text("Average Brightness: " + String.format("%2.2f",averageBrightness*255) + "/255",averageBrightness*(width - picWidth - 50),height - (float)linePosition/10 - 370);
  }
